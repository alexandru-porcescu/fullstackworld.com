...
class TeamController
{
    ...
    public function store($id)
    {
        ...
        validator($data, [
            ...
            'name' => 'required',
            'slug' => 'required|'.Rule::unique(config('wink.database_connection').'.authors', 'slug')->ignore(request('id')),
            'email' => 'required|email|'.Rule::unique(config('wink.database_connection').'.authors', 'email')->ignore(request('id')),
        ])->validate();
